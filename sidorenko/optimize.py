...
from .density import objective_and_grad, unpack, weights_from_psi

__all__ = ["make_starts", "run_graph", "TRIGGER"]

# Threshold for declaring a float hit.  Since B is rescaled so that
# t(K_2, W) = 1, F = log t(H, W) with t near 1 in the flat region, and the
# accumulated float error of one contraction is a few 1e-16 relative; 1e-9
